...
(function() {
     ...
     * @constructor
     */
    function localResizeIMG(file, options, callback) {
        this.file = file;
    ...
    localResizeIMG.prototype = {
        constructor: localResizeIMG,
    ...
    // 暴露接口
    window.localResizeIMG = function(file, options, callback) {
        return new localResizeIMG(file, options, callback);
    };
})()